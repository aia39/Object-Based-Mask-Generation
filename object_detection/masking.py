...
Code for Generating Color Coded Mask from video 
...
ap.add_argument("-i", "--inp",type=str,default="input_folder_name",
help="path to input video")
ap.add_argument("-o", "--out", type=str, default='output_folder_name',
help="Output folder")
...
def masking(image, image_tensor,tensor_dict):
